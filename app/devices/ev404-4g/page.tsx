        ...
        <div className="grid gap-10 lg:grid-cols-2">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="mt-6 text-lg leading-9 text-gray-600">
              جهاز تتبع GPS صغير الحجم وخفيف الوزن، يعمل بتقنية
              4G مع دعم 2G، ويوفر متابعة لحظية للمركبة مع مجموعة
            ...
            <div className="mt-6 grid gap-4 sm:grid-cols-2">
              ...
              <a
                href="https://wa.me/201006687163?text=مرحبًا، أريد الاستفسار عن جهاز EV404 4G"
                target="_blank"
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          ...
          <div className="rounded-3xl bg-white p-7 shadow-md">
            ...
            <ul className="space-y-4 text-lg leading-8 text-gray-700">
              ...
              <li>
                📦 تصميم صغير وخفيف وسهل التركيب.
              </li>

              <li>
                📡 يعمل على شبكات 4G LTE مع دعم 2G.
              </li>
              ...
              <li>
                🎙️ يدعم المراقبة الصوتية.
              </li>

              <li>
                ⚡ إمكانية فصل الوقود أو الكهرباء عن بُعد عند تجهيز النظام لذلك.
              </li>
              ...
              <li>
                🔋 تنبيه انخفاض البطارية ومحاولة إزالة الجهاز.
              </li>

              <li>
                🌐 يعمل مع أنظمة التتبع والسيرفرات المتوافقة.
              </li>
      ...
      <section className="bg-blue-50 px-5 py-16">
        ...
        <div className="mx-auto max-w-5xl text-center">
          ...
          <p className="mx-auto mt-5 max-w-3xl text-lg leading-9 text-gray-600">
            جهاز عملي يجمع بين الحجم الصغير ودعم شبكات 4G
            و2G، مع مجموعة من وظائف التتبع والتنبيهات والحماية،
            مما يجعله مناسبًا لمتابعة مختلف المركبات.
          </p>
      ...
      <section className="mx-auto max-w-5xl px-5 py-16">
        ...
        <div className="rounded-3xl bg-blue-950 p-8 text-center text-white shadow-xl md:p-12">
          ...
          <div className="mt-8 flex flex-col justify-center gap-4 sm:flex-row">
            ...
            <a
              href="https://wa.me/201006687163?text=مرحبًا، أريد طلب جهاز EV404 4G"
              target="_blank"
              rel="noopener noreferrer"
