        ...
        <div className="grid gap-10 lg:grid-cols-2">
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="mt-6 grid gap-4 sm:grid-cols-2">
              ...
              <a
                href="https://wa.me/201006687163?text=مرحبًا، أريد الاستفسار عن جهاز AK300"
                target="_blank"
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          ...
          <div className="rounded-3xl bg-white p-7 shadow-md">
            ...
            <ul className="space-y-4 text-lg leading-8 text-gray-700">
              ...
              <li>
                📡 يدعم الاتصال بأنظمة GPS المتوافقة.
              </li>

              <li>
                🚨 دعم مجموعة من تنبيهات الحركة والحماية.
              </li>
      ...
      <section className="mx-auto max-w-5xl px-5 py-16">
        ...
        <div className="rounded-3xl bg-blue-950 p-8 text-center text-white shadow-xl md:p-12">
          ...
          <div className="mt-8 flex flex-col justify-center gap-4 sm:flex-row">
            ...
            <a
              href="https://wa.me/201006687163?text=مرحبًا، أريد طلب جهاز AK300"
              target="_blank"
              rel="noopener noreferrer"
