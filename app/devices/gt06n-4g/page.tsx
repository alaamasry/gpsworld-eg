        ...
        <div className="grid gap-10 lg:grid-cols-2">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="mt-6 text-lg leading-9 text-gray-600">
              جهاز GT06N 4G هو جهاز تتبع GPS يعمل بتقنية 4G، ومناسب لمتابعة
              السيارات والمركبات ومعرفة الموقع بشكل لحظي. يوفر الجهاز مجموعة
              من وظائف التتبع والتنبيهات والحماية، مع إمكانية الإدارة من خلال
        ...
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center">
            ...
            <p className="mx-auto mt-4 max-w-3xl text-lg leading-9 text-gray-600">
              ...
              ومراقبة الحركة مع مجموعة من وظائف التنبيه والحماية.
            </p>
          </div>
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            <div className="rounded-3xl bg-gray-50 p-6 text-center shadow-sm">
              ...
              <p className="mt-3 leading-8 text-gray-600">
                معرفة موقع المركبة ومتابعة حركتها من خلال نظام التتبع المتوافق.
              </p>
            </div>
            ...
            <div className="rounded-3xl bg-gray-50 p-6 text-center shadow-sm">
              ...
              <p className="mt-3 leading-8 text-gray-600">
                تحديد منطقة جغرافية ومتابعة دخول المركبة إليها أو خروجها منها.
              </p>
            </div>
      ...
      <section className="mx-auto max-w-7xl px-5 py-16">
        <div className="rounded-3xl bg-blue-50 p-8 md:p-12">
          <div className="text-center">
            ...
            <p className="mx-auto mt-4 max-w-3xl text-lg leading-9 text-gray-600">
              يمكن استخدام الجهاز في العديد من تطبيقات تتبع ومراقبة السيارات
              والمركبات.
            </p>
          </div>
          ...
          <div className="mt-8 grid gap-5 text-right md:grid-cols-3">
            <div className="rounded-2xl bg-white p-6 shadow-sm">
              ...
              <p className="mt-2 leading-7 text-gray-600">
                اتصال مناسب لتطبيقات التتبع الحديثة.
              </p>
            </div>
            ...
            <div className="rounded-2xl bg-white p-6 shadow-sm">
              ...
              <p className="mt-2 leading-7 text-gray-600">
                مناسب للسيارات والمركبات وتطبيقات الأساطيل.
              </p>
            </div>
