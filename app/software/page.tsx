...
export const metadata: Metadata = {
  title: "برامج وسيرفرات GPS لتتبع السيارات في مصر",
  description:
    "برامج وسيرفرات GPS لتشغيل ومتابعة أجهزة التتبع وإدارة المركبات ومعرفة الموقع والحركة، مع شحن نقاط السيرفر والدعم الفني في مصر من GPS World Egypt.",
  keywords: [
    "برامج GPS",
    "برامج تتبع السيارات",
    "برنامج GPS للسيارات",
  ...
  alternates: {
    canonical: "https://gpsworld-eg.com/software",
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "برامج وسيرفرات GPS لتتبع السيارات في مصر | GPS World Egypt",
    description:
      "حلول برامج وسيرفرات GPS لتشغيل ومتابعة أجهزة التتبع وإدارة المركبات، مع شحن نقاط السيرفر والدعم الفني في مصر.",
  ...
  twitter: {
    ...
    title: "برامج وسيرفرات GPS لتتبع السيارات في مصر",
    description:
      "برامج وسيرفرات GPS لتشغيل ومتابعة أجهزة التتبع وإدارة المركبات مع شحن نقاط السيرفر والدعم الفني.",
  },
};
      ...
      <section className="bg-gradient-to-b from-blue-50 to-white">
        <div className="mx-auto max-w-7xl px-5 py-20 text-center md:py-28">
          ...
          <p className="mx-auto mt-6 max-w-3xl text-base leading-8 text-gray-600 md:text-lg">
            ...
            السيرفرات والبرامج وحتى شحن النقاط والدعم الفني، لمساعدتك
            في متابعة المركبات ومعرفة الموقع والحركة بسهولة.
          </p>
        ...
        <div className="mx-auto max-w-6xl px-5">
          <div className="rounded-3xl bg-[#071a35] px-6 py-12 text-center text-white shadow-xl md:px-12">
            ...
            <h2 className="mt-4 text-3xl font-black md:text-4xl">
              لماذا تختار GPS World Egypt لبرامج وسيرفرات GPS؟
            </h2>
      ...
      <section className="bg-white py-20">
        <div className="mx-auto max-w-5xl px-5 text-center">
          <h2 className="text-3xl font-black text-[#071a35] md:text-4xl">
            محتاج برنامج أو سيرفر GPS مناسب؟
          </h2>

          <p className="mx-auto mt-4 max-w-2xl leading-7 text-gray-600">
            تواصل معنا وسنساعدك في اختيار الجهاز والسيرفر والخدمة
            المناسبة لاحتياجاتك، سواء للمتابعة الشخصية أو للمركبات
            وإدارة التتبع.
          </p>
