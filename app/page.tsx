...
const devices = [
  {
    ...
    description: "جهاز GPS احترافي للتتبع والمراقبة.",
  },
...

  {
    ...
    badge: "متوفر",
    badgeColor: "bg-blue-600",
    description: "جهاز تتبع GPS يعمل من خلال منفذ OBD.",
  },

  {
    ...
    badge: "متوفر",
    badgeColor: "bg-blue-600",
    description: "جهاز تتبع GPS عملي وسهل التركيب.",
  },

  {
    ...
    badge: "متوفر",
    badgeColor: "bg-blue-600",
    description: "جهاز GPS صغير الحجم للتتبع والمراقبة.",
  },

  {
    ...
    badge: "متوفر",
    badgeColor: "bg-blue-600",
    description: "جهاز GPS للتتبع والمراقبة.",
  },
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="text-center py-24 px-5">
        ...
        <p className="text-xl text-gray-600 mb-10">
          بيع أجهزة التتبع - شحن نقاط السيرفرات - السوفت وير - الدعم الفني
        </p>
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8">
          ...
          {devices.map((device, index) => (
            ...
            <div
              key={index}
              className="border rounded-xl p-5 shadow-lg hover:shadow-2xl transition"
            >
              ...
              <span
                className={`${device.badgeColor} text-white text-sm px-3 py-1 rounded-full mt-4 inline-block`}
              >
                {device.badge}
              </span>
              ...
              {/* عرض التفاصيل */}
              <a
                href={device.id ? `/devices/${device.id}` : "#"}
                className="mt-5 w-full bg-blue-700 text-white py-3 rounded-lg hover:bg-blue-800 block text-center"
              >
                عرض التفاصيل
              </a>

              {/* استفسار واتساب عن الموديل */}
              <a
                href={`https://wa.me/201006687163?text=${encodeURIComponent(
                  `مرحبًا، أريد الاستفسار عن جهاز GPS موديل ${device.name}`
                )}`}
                target="_blank"
                rel="noopener noreferrer"
                className="mt-3 w-full bg-green-600 text-white py-3 rounded-lg hover:bg-green-700 block text-center"
              >
                💬 استفسار عن {device.name}
              </a>
      ...
      >
        ...
        <p className="text-center text-gray-600 text-lg mb-10">
          برامج وحلول GPS المتاحة لعملائنا
        </p>

        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8">

          <div className="border rounded-xl p-5 shadow-lg hover:shadow-2xl transition">
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-6 right-6 w-16 h-16 rounded-full bg-green-500 hover:bg-green-600 text-white text-3xl flex items-center justify-center shadow-2xl transition"
      >
        💬
      </a>
